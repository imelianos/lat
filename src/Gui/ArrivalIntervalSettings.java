...
public class ArrivalIntervalSettings {
	...
	public JScrollPane getArrivalIntervalSettingsPanel(XMLSimulatorSettings xmlSettings) throws IOException {

		JPanel simulatorArrivalIntervalSetingsPanel = new JPanel(new FlowLayout(FlowLayout.CENTER));
		
		JScrollPane scrollableSimulatorArrivalIntervalSetingsPanel = new JScrollPane(simulatorArrivalIntervalSetingsPanel);		

		JPanel simulatorArrivalIntervalSetingsPanelInner = new JPanel(new GridLayout(25, 3, 0, 10));

		simulatorArrivalIntervalSetingsPanel.add(simulatorArrivalIntervalSetingsPanelInner);
		...
		String readInterArrivalsFromXML = xmlSettings.loadXML("meanHourlyArrivalInterval");
		
		String arrayLine[] = new String[getNumberOfPlacesInTheArray(readInterArrivalsFromXML)];

		arrayLine = readInterArrivalsFromXML.split(",");
		...
		simulatorArrivalIntervalSetingsPanelInner.add(valueLabel);

		simulatorArrivalIntervalSetingsPanelInner.add(currentValueLabel);

		simulatorArrivalIntervalSetingsPanelInner.add(newValueLabel);
		
		
		//00:00-01:00
		simulatorArrivalIntervalSetingsPanelInner.add(Label_0_1);

		simulatorArrivalIntervalSetingsPanelInner.add(currentLabel_0_1);

		simulatorArrivalIntervalSetingsPanelInner.add(spinner_0_1);
		
		//01:00-02:00
		simulatorArrivalIntervalSetingsPanelInner.add(Label_1_2);

		simulatorArrivalIntervalSetingsPanelInner.add(currentLabel_1_2);

		simulatorArrivalIntervalSetingsPanelInner.add(spinner_1_2);
		
		//02:00-03:00
		simulatorArrivalIntervalSetingsPanelInner.add(Label_2_3);

		simulatorArrivalIntervalSetingsPanelInner.add(currentLabel_2_3);

		simulatorArrivalIntervalSetingsPanelInner.add(spinner_2_3);
		
		//03:00-04:00
		simulatorArrivalIntervalSetingsPanelInner.add(Label_3_4);

		simulatorArrivalIntervalSetingsPanelInner.add(currentLabel_3_4);

		simulatorArrivalIntervalSetingsPanelInner.add(spinner_3_4);
		
		//04:00-05:00
		simulatorArrivalIntervalSetingsPanelInner.add(Label_4_5);

		simulatorArrivalIntervalSetingsPanelInner.add(currentLabel_4_5);

		simulatorArrivalIntervalSetingsPanelInner.add(spinner_4_5);
		
		//05:00-06:00
		simulatorArrivalIntervalSetingsPanelInner.add(Label_5_6);

		simulatorArrivalIntervalSetingsPanelInner.add(currentLabel_5_6);

		simulatorArrivalIntervalSetingsPanelInner.add(spinner_5_6);
		
		//06:00-07:00
		simulatorArrivalIntervalSetingsPanelInner.add(Label_6_7);

		simulatorArrivalIntervalSetingsPanelInner.add(currentLabel_6_7);

		simulatorArrivalIntervalSetingsPanelInner.add(spinner_6_7);
		
		//07:00-08:00
		simulatorArrivalIntervalSetingsPanelInner.add(Label_7_8);

		simulatorArrivalIntervalSetingsPanelInner.add(currentLabel_7_8);

		simulatorArrivalIntervalSetingsPanelInner.add(spinner_7_8);
		
		//08:00-09:00
		simulatorArrivalIntervalSetingsPanelInner.add(Label_8_9);

		simulatorArrivalIntervalSetingsPanelInner.add(currentLabel_8_9);

		simulatorArrivalIntervalSetingsPanelInner.add(spinner_8_9);
		
		//09:00-10:00
		simulatorArrivalIntervalSetingsPanelInner.add(Label_9_10);

		simulatorArrivalIntervalSetingsPanelInner.add(currentLabel_9_10);

		simulatorArrivalIntervalSetingsPanelInner.add(spinner_9_10);
		
		//10:00-11:00
		simulatorArrivalIntervalSetingsPanelInner.add(Label_10_11);

		simulatorArrivalIntervalSetingsPanelInner.add(currentLabel_10_11);

		simulatorArrivalIntervalSetingsPanelInner.add(spinner_10_11);
		
		//11:00-12:00
		simulatorArrivalIntervalSetingsPanelInner.add(Label_11_12);

		simulatorArrivalIntervalSetingsPanelInner.add(currentLabel_11_12);

		simulatorArrivalIntervalSetingsPanelInner.add(spinner_11_12);
		
		//12:00-13:00
		simulatorArrivalIntervalSetingsPanelInner.add(Label_12_13);

		simulatorArrivalIntervalSetingsPanelInner.add(currentLabel_12_13);

		simulatorArrivalIntervalSetingsPanelInner.add(spinner_12_13);
		
		//13:00-14:00
		simulatorArrivalIntervalSetingsPanelInner.add(Label_13_14);

		simulatorArrivalIntervalSetingsPanelInner.add(currentLabel_13_14);

		simulatorArrivalIntervalSetingsPanelInner.add(spinner_13_14);
		
		//14:00-15:00
		simulatorArrivalIntervalSetingsPanelInner.add(Label_14_15);

		simulatorArrivalIntervalSetingsPanelInner.add(currentLabel_14_15);

		simulatorArrivalIntervalSetingsPanelInner.add(spinner_14_15);
		
		//15:00-16:00
		simulatorArrivalIntervalSetingsPanelInner.add(Label_15_16);

		simulatorArrivalIntervalSetingsPanelInner.add(currentLabel_15_16);

		simulatorArrivalIntervalSetingsPanelInner.add(spinner_15_16);
		
		//16:00-17:00
		simulatorArrivalIntervalSetingsPanelInner.add(Label_16_17);

		simulatorArrivalIntervalSetingsPanelInner.add(currentLabel_16_17);

		simulatorArrivalIntervalSetingsPanelInner.add(spinner_16_17);
		
		//17:00-18:00
		simulatorArrivalIntervalSetingsPanelInner.add(Label_17_18);

		simulatorArrivalIntervalSetingsPanelInner.add(currentLabel_17_18);

		simulatorArrivalIntervalSetingsPanelInner.add(spinner_17_18);
		
		//18:00-19:00
		simulatorArrivalIntervalSetingsPanelInner.add(Label_18_19);

		simulatorArrivalIntervalSetingsPanelInner.add(currentLabel_18_19);

		simulatorArrivalIntervalSetingsPanelInner.add(spinner_18_19);
		
		//19:00-20:00
		simulatorArrivalIntervalSetingsPanelInner.add(Label_19_20);

		simulatorArrivalIntervalSetingsPanelInner.add(currentLabel_19_20);

		simulatorArrivalIntervalSetingsPanelInner.add(spinner_19_20);
		
		//20:00-21:00
		simulatorArrivalIntervalSetingsPanelInner.add(Label_20_21);

		simulatorArrivalIntervalSetingsPanelInner.add(currentLabel_20_21);

		simulatorArrivalIntervalSetingsPanelInner.add(spinner_20_21);
		
		//21:00-22:00
		simulatorArrivalIntervalSetingsPanelInner.add(Label_21_22);

		simulatorArrivalIntervalSetingsPanelInner.add(currentLabel_21_22);

		simulatorArrivalIntervalSetingsPanelInner.add(spinner_21_22);
		
		//22:00-23:00
		simulatorArrivalIntervalSetingsPanelInner.add(Label_22_23);

		simulatorArrivalIntervalSetingsPanelInner.add(currentLabel_22_23);

		simulatorArrivalIntervalSetingsPanelInner.add(spinner_22_23);
		
		//23:00-00:00
		simulatorArrivalIntervalSetingsPanelInner.add(Label_23_0);

		simulatorArrivalIntervalSetingsPanelInner.add(currentLabel_23_0);

		simulatorArrivalIntervalSetingsPanelInner.add(spinner_23_0);

		
		return scrollableSimulatorArrivalIntervalSetingsPanel;
	}
	...
	public static String getArrivalIntervalSettings(){
